...
<html>
  ...
  <body>
         ...
         <s:form action="UserAuthorizeAction-updateAuthorize" namespace="/" method="post" onsubmit="selectAll()">
            <table cellspacing="1" border="1" bordercolor="#ccc" width="900px;">
                <s:hidden name="id"/>
                <tr>
                   <td class="table_label">username：</td>
                   <td class="table_val">
                        <s:textfield name="username" cssClass="text" readonly="true"/>
                   </td>
                </tr>
                <tr>
                   <td class="table_label">nickName：</td>
                   <td class="table_val">
                        <s:textfield name="nickName" cssClass="text" readonly="true"/>
                   </td>
                </tr>
                <tr>
                   <td class="table_label">email：</td>
                   <td class="table_val">
                         <s:textfield name="email" cssClass="text" readonly="true"/>
                   </td>
                </tr>
                <tr>
                   <td colspan="2">
                       ...
                       <table cellspacing="1" border="1" bordercolor="#ccc" width="100%">
                           <tr height="300px;">
                               <td width="35%">
                                    <select id="left" name="wonRoleIds" multiple="multiple">
                               ...
                               <td width="35%">
                                     <select id="right" multiple="multiple">
                                         <s:iterator var="no" value="noWonRoles">
                                             <option value='<s:property value="#no.id"/>'>
                                                 <s:property value="#no.roleName"/>
                                             </option>
                                         </s:iterator>
                                     </select>
                               </td>
